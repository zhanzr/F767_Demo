...
void make_arp_answer_from_request(unsigned char *buf)
{
    ...
    printf("\n\rSTM32F767 Nucleo Board[%d.%d.%d.%d]发送ARP相应",ipaddr[0],ipaddr[1],ipaddr[2],ipaddr[3]);
...
void make_echo_reply_from_request(unsigned char *buf,unsigned  int len)
{
    ...
    printf("\n\rSTM32F767 Nucleo Board[%d.%d.%d.%d]发送ICMP包响应",ipaddr[0],ipaddr[1],ipaddr[2],ipaddr[3]);
...
void make_tcp_synack_from_syn(unsigned char *buf)
{
    ...
    printf("\n\rSTM32F767 Nucleo Board[%d.%d.%d.%d]发送SYN包响应",ipaddr[0],ipaddr[1],ipaddr[2],ipaddr[3]);
...
void make_tcp_ack_from_any(unsigned char *buf)
{
    ...
    printf("\n\rSTM32F767 Nucleo Board[%d.%d.%d.%d]发送ACK包响应",ipaddr[0],ipaddr[1],ipaddr[2],ipaddr[3]);
