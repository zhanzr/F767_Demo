...
__attribute__((section(".RxDescripSection"), aligned(4), used))
ETH_DMADescTypeDef DMARxDscrTab[ETH_RX_DESC_CNT];
/* Ethernet Tx DMA Descriptors */
__attribute__((section(".TxDescripSection"), aligned(4), used))
ETH_DMADescTypeDef DMATxDscrTab[ETH_TX_DESC_CNT];

// Optional: If you want to use remaining SRAM2 for a custom buffer
//__attribute__((section(".SRAM2_data"), used))
//uint8_t my_ethernet_buffer[4096];
#endif
